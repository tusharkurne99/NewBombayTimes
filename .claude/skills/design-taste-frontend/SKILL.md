...
description: Anti-AI-slop frontend design guidance for landing pages, portfolios, and redesigns -- typography/color/layout discipline, banned AI "tells" (em-dashes, generic three-card rows, AI-purple gradients, etc.), accessibility and motion rules, and a pre-flight checklist. Sourced from github.com/leonxlnx/taste-skill (the "taste-skill" v2 folder), installed manually since this environment has no Node/npx to run the project's own installer.
---
